...
class Localizations(Base):
    ...
    def language_by_id_locator(self, language_id):
    ...
    def get_language_table(self, table_locator):
    ...
    def released_languages(self):
        return self.get_language_table(self._released_languages_locator)

    @property
    def beta_languages(self):
        return self.get_language_table(self._beta_languages_locator)

    def language_by_id(self, language_id):
        return self.Language(self.selenium.find_element(
            *self.language_by_id_locator(language_id)))
