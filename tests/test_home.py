...
class TestHomePage:
    ...
    def test_tabzilla_link_destinations_are_corrects(self, mozwebqa):
        home_page = HomePage(mozwebqa)
        home_page.go_to_page()
        Assert.true(home_page.header.is_tabzilla_panel_visible)
        home_page.header.toggle_tabzilla_dropdown()
        bad_links = []
        for link in HomePage.Header.tabzilla_links_list:
            url = home_page.link_destination(link.get('locator'))
    ...
    def test_tabzilla_links_are_visible(self, mozwebqa):
        ...
        home_page.header.toggle_tabzilla_dropdown()
        bad_links = []
        for link in home_page.header.tabzilla_links_list:
    ...
    def test_sign_up_form_fields_are_visible(self, mozwebqa):
        ...
        bad_fields = []
        for field in home_page.sign_up_form_fields:
            if not home_page.is_element_visible(*field.get('locator')):
    ...
    def test_sign_up_form_elements_are_visible(self, mozwebqa):
        ...
        home_page.expand_sign_up_form()
        home_page.wait_for_element_visible(*home_page._sign_up_form_privacy_checkbox_locator)
        home_page.is_element_visible(*home_page._sign_up_form_country_select_locator)
